    ...
    <div className="flex flex-col gap-3">
      <div className="flex items-center gap-2">
        <input
          ...
          className="border border-gray-300 rounded px-3 py-2 text-sm flex-1 focus:outline-none focus:ring-2 focus:ring-golf-green"
        />
      ...
      <div className="overflow-y-auto max-h-[50vh] sm:max-h-96 border border-gray-200 rounded-lg divide-y divide-gray-100">
        {filtered.length === 0 && (
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2.5">
                {isPicked ? (
                  <span className="w-5 h-5 rounded-full bg-golf-green text-white text-xs flex items-center justify-center font-bold flex-shrink-0">
                    ✓
                  </span>
                ) : (
